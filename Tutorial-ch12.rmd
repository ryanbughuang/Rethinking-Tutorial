...
The ideas of CI and PI can also be applied here. We can either predict for an "average" chimpanzee, whose intercept is exactly $\bar\alpha$, or an individual chimpanzee, whose intercept is drawn from $N(\bar\alpha, \sigma_{alpha})$. 

They will be denoted as **p_bar** and **p_sim** respectively.
