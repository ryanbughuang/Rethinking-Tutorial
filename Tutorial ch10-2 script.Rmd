...
#### Math Model
The trend for societies with high contact is higher than that for societies with low contact when population size is low, but the model allows the trend for high contact to be smaller when population size is high.
...
### Data
Let's create the fake data. Assuming that the occurence rates are 1.5/day in place A and 0.5/day in place B.

We want to estimate these two occurence rates using one model.
```{r}
num_days = 30
