...
We will talk about these cases in the tutorial:
  ...
  3. social relations model(categorical variables(ch14.4))
...
The correlation here is positive and strong. This implies that pairs of households are balanced— if one household gives less than average (after accounting for generalized giving and receiv- ing), then the other probably gives less back as well.
```{r}
